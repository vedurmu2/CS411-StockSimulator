    ...
    <![endif]-->
        ...
        <script type="text/javascript">
            ...
            $("#ChangeName").submit(function(event){
              $.post($("#ChangeName").attr("action"), $("#ChangeName").serialize(), function(data){ 
                  if (data == "")
        ...
        <div class="modal-dialog">
            <form id="ChangeName" action="form_submisions/change_name.php" method="post">
              <div class="modal-content">
                ...
                <div class="modal-body" style= "padding-top: 0px;" >
                  <div class="divDialogElements">
                    <h4>New Name</h4>
                    <input class="xlarge" id="xlInput" name="newname" value="" type="text">
                    <h4>Password</h4>
